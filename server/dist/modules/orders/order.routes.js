...
router.post("/", auth_middleware_1.authenticate, (0, validate_middleware_1.validate)(order_schema_1.createSalesOrderSchema), (0, asyncHandler_1.asyncHandler)(controller.create));
router.patch("/:id", auth_middleware_1.authenticate, (0, validate_middleware_1.validate)(order_schema_1.updateSalesOrderSchema), (0, asyncHandler_1.asyncHandler)(controller.update));
...
router.patch("/:id/cancel", auth_middleware_1.authenticate, (0, asyncHandler_1.asyncHandler)(controller.cancel));
// ✅ Convert Quote → Order
router.post("/convert-from-quote/:quoteId", auth_middleware_1.authenticate, (0, authorize_middleware_1.requirePermission)("sales-order.create"), (0, asyncHandler_1.asyncHandler)(controller.convertFromQuote));
